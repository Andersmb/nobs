from functions import reactions, basis_sets_ordered, functionals, load_data, get_reaction_energies, AU2KCAL
    ...
    for rxn in gto.keys():
        for func in functionals:
            ...
            for bas in basis_sets_ordered:
                ...
                data[cp][func][bas].append((rxn, ae))
...
fig.text(0.04, 0.5, "Absolute Error [kcal/mol]", va="center", rotation="vertical", fontsize=fs)
...
plt.savefig("figs/absolute_errors.png")